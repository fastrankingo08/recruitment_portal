...
<html lang="en" class="light-theme">
  <head>
    ...
    <title>FR CRM - Create Followup</title>
            ...
            <div class="ps-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Create Follow Up</li>
                </ol>
              </nav>
            </div>
            <div class="ms-auto">
            ...
            <div class="col-xl-8 mx-auto">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">Create New Follow Up</h6>
                  <hr>
                  <!-- Form Start -->
                  <form class="row g-3" action="create_follow_up_act.php" method="post">
                      <div class="d-grid col-4">
                        <label class="form-label">Ttile <span class="error_msg">*</span></label>
                        <select class="form-select" name="tile"  required>
                      ...
                      <div class="d-grid col-4">
                        <label class="form-label">RPC Verification <span class="error_msg">*</span></label>
                        <select class="form-select" name="rpcverify"  required>
                            <option selected disabled value="">Select RPC</option>
                            <option value="RPC Verified">RPC Verified</option>
                            <option value="RPC Not Verified">RPC Not Verified</option>
                          </select>
                      </div>
                      <div class="d-grid col-4">
                      ...
                      <div class="d-grid col-4">
                        <label class="form-label">Phone Number <span class="error_msg">*</span></label>
                      ...
                      <div class="d-grid col-4">
                        <label class="form-label">Follow Up Status <span class="error_msg">*</span></label>
                        <select class="form-select" name="followupstatus"  required>
                      ...
                      <div class="d-grid col-4">
                        <label class="form-label">Follow Up Source <span class="error_msg">*</span></label>
                        <select class="form-select" name="followupsource"  required>
                            <option selected disabled value="">Select Source</option>
                            <option value="Auto Dialer">Auto Dialer</option>
                            <option value="Manually Dailed">Manually Dailed</option>
                            <option value="Social Media">Social Media</option>
                            <option value="Website">Website</option>
                          </select>
                      </div>
                      <div class="d-grid col-4">
                        <label class="form-label">Follow Up Date <span class="error_msg">*</span></label>
                        <input type="date" name="followupdate" class="form-control">
                      </div>
                      <div class="d-grid col-4">
                        <label class="form-label">Follow Up Time <span class="error_msg">*</span></label>
                        <input type="time" name="followuptime" class="form-control">
                        
                      </div>
                      <div class="col-12">
                        <label class="form-label">Agent Comments <span class="error_msg">*</span></label>
                        <textarea class="form-control" name="agentcomments" rows="4" cols="4" placeholder="Agent Comments..."></textarea>
                       </div>
                    <div class="col-12">
                      <div class="row">
