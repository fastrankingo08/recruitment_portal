            ...
            <div class="ps-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">View My Meeting</li>
                </ol>
              </nav>
            </div>
            <div class="ms-auto">
            ...
            <div class="col-xl-8 mx-auto">
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">View My Meeting</h6>
                  <hr>
                  <form class="row g-3">
...
<div class="row">
    <div class="col-xl-12 mx-auto">
      <div class="card">
            <div class="card-body">
                <div class="border p-3 rounded">
                    <h6 class="mb-0 text-uppercase">Recent Comments</h6>
                    <hr>
                    <form class="row g-3">
                        <table class="table mb-0 table-striped">
                            <tbody>
                                <tr>
                                  ...
                                  <td>catherine</td>
                                  <td>1142352233 Carley,ring bck tomorrow dinner time about 2/3pm,Hair Union.Friday or Tues, only RPC</td>
                                </tr>
                            </tbody>
                        </table>
                    </form>
