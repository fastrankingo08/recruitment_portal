       ...
       <aside class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
          ...
          <li>
            ...
            <ul>
              <li> <a href="create-department.php"><ion-icon name="ellipse-outline"></ion-icon>Create Department</a>
              </li>
              <li> <a href="view-departments.php"><ion-icon name="ellipse-outline"></ion-icon>View Departments</a>
              </li>
              <li> <a href="create-designation.php"><ion-icon name="ellipse-outline"></ion-icon>Create Designation</a>
              </li>
              <li> <a href="view-designation.php"><ion-icon name="ellipse-outline"></ion-icon>View Designation</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li> <a href="type-of-user.php"><ion-icon name="ellipse-outline"></ion-icon>Type Of User</a>
              </li>
              <li> <a href="role-of-user.php"><ion-icon name="ellipse-outline"></ion-icon>Role Of User</a>
              </li>
              <li> <a href="create-user.php"><ion-icon name="ellipse-outline"></ion-icon>Create User</a>
              </li>
              <li> <a href="view-users.php"><ion-icon name="ellipse-outline"></ion-icon>View Users</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              <li><a href="create-mail-form.php"><ion-icon name="ellipse-outline"></ion-icon>Create Mail Form</a>
              </li>
              <li><a href="my-mail-form.php"><ion-icon name="ellipse-outline"></ion-icon>My Mail Form</a>
              </li>
              <li><a href="all-mail-form.php"><ion-icon name="ellipse-outline"></ion-icon>All Mail Form</a>
              </li>
          ...
          <li>
            ...
            <ul>
              <li> <a href="create-follow-up.php"><ion-icon name="ellipse-outline"></ion-icon>Create Follow Up</a>
              </li>
              <li> <a href="my-follow-up.php"><ion-icon name="ellipse-outline"></ion-icon>My Follow Up</a>
              </li>
              <li> <a href="all-follow-up.php"><ion-icon name="ellipse-outline"></ion-icon>All Follow Up</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li> <a href="create-meeting.php"><ion-icon name="ellipse-outline"></ion-icon>Create Meeting</a>
              </li>
              <li> <a href="my-meetings.php"><ion-icon name="ellipse-outline"></ion-icon>My Meetings</a>
              </li>
              <li> <a href="all-meetings.php"><ion-icon name="ellipse-outline"></ion-icon>All Meetings</a>
              </li>
          ...
          <li>
            ...
            <ul>
              <li> <a href="todays-meetings.php"><ion-icon name="ellipse-outline"></ion-icon>Today's Meeting</a>
              </li>
              <li> <a href="todays-followup.php"><ion-icon name="ellipse-outline"></ion-icon>Today's Follow Up</a>
              </li>
            ...
            <div class="col-xl-8 mx-auto">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">Business Details</h6>
                  <hr>
                  <form class="">
                    <div class="row g-3" id="id='authperson-1'">
                    <div class="d-grid col-4">
                        <label class="form-label">Business Name <span class="error_msg">*</span></label>
                      <input type="text" class="form-control" name="" placeholder="Business Name" required>
                      </div>

                      <div class="d-grid col-4">
                        <label class="form-label">Category <span class="error_msg">*</span></label>
                      ...
                      <div class="d-grid col-4">
                        <label class="form-label">Website <span class="error_msg">*</span></label>
                      <input type="text" class="form-control" name="" placeholder="Website" required>
                      </div>
                      <div class="d-grid col-4">
                      ...
                      <div class="d-grid col-4">
                        <label class="form-label">Business Address 1 <span class="error_msg">*</span></label>
                      <input type="email" class="form-control" name="" placeholder="Business Address 1" required>
                      </div>
                      <div class="d-grid col-4">
                        <label class="form-label">Business Address 2 <span class="error_msg">*</span></label>
                      <input type="email" class="form-control" name="" placeholder="Business Address 2" required>
                      </div>
                      <div class="d-grid col-4">
