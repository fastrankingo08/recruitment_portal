        ...
        <div class="page-content-wrapper">
         ...
         <div class="page-content">
          ...
          <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Organization</div>
            <div class="ps-3">
            ...
            <div class="col-xl-8 mx-auto">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">Create Department</h6>
                  <hr>
                  <!-- Form Start -->
                  <form class="row g-3" method="post" action="create_department_act.php">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <select class="form-select"  required name="parentDepartment">
                    ...
                    <div class="col-6">
                      <div class="col-12 d-flex">
                          <div class="form-check col-3">
                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="Active">
                            <label class="form-check-label" for="flexRadioDefault1">Active</label>
                          </div>
                          <div class="form-check col-3">
                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="Draft">
                            <label class="form-check-label" for="flexRadioDefault1">Draft</label>
                          </div>
                          <div class="col-6"></div>
                      </div>
                    </div>
