            ...
            <div class="col-xl-8 mx-auto">
              <div class="card">
                <div class="card-body">
                  ...
                  <h6 class="mb-0 text-uppercase">View User</h6>
                  <hr>
                  <form class="row g-3">
                  <!-- Table Start -->
                    <table class="table mb-0 table-striped">
                        ...
                        <!-- Fetching Data from database -->
                                <?php
                                //query of data fetching from the server
                                $query = "SELECT * FROM fr_new_user WHERE Email_Id = '$mailId'";
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td ><?php echo $data['Reporting_to'];?></td>
                          </tr>
                          <tr>
